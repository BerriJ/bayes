...
knitr::kable(sum_var, digits = 2, caption = '\\label{tab:sum} Summary', col.names = c('', 'year', '', 'N', ' ', 'mean', 'sd' ), row.names = FALSE )

```

As one can see in Table \ref{tab:sum} the differences between the versions for the most important variables are considerable small. For the variable overall `r mean(fifa_data) ` 
